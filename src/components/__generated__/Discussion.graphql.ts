...
export type Discussion$data = {
  ...
  readonly id: string;
  readonly " $fragmentType": "Discussion";
};
export type Discussion$key = {
  readonly " $data"?: Discussion$data;
...
return {
  ...
  "metadata": {
    ...
    "refetch": {
      ...
      "operation": require('./DiscussionPaginatedRefetchQuery.graphql'),
      "identifierField": "id"
    }
  },
  "name": "Discussion",
  "selections": [
    (v1/*: any*/),
    {
      ...
      "kind": "LinkedField",
      "name": "__Discussions_comments_connection",
      "plural": false,
      "selections": [
        {
          "alias": null,
